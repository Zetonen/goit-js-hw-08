...
var SAVE_KEY_CODE = "feedback-form-state";
var refs = {
  form: document.querySelector(".feedback-form")
};
updatingFormValues();
refs.form.addEventListener("input", (0, _lodash.default)(onInputValues, 500));
refs.form.addEventListener("click", resetForm);
function onInputValues(e) {
  var formValues = {};
  var formData = new FormData(refs.form);
  formData.forEach(function (y, x) {
    formValues[x] = y;
  });
  (0, _storage.save)(SAVE_KEY_CODE, formValues);
}
function updatingFormValues() {
  var saveValues = (0, _storage.load)(SAVE_KEY_CODE);
  if (saveValues) {
    var formValues = Object.entries(saveValues);
    formValues.forEach(function (value) {
      var inputEl = document.querySelector("[name=".concat(value[0], "]"));
...
},{"lodash.throttle":"../node_modules/lodash.throttle/index.js","./storage.js":"js/storage.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
